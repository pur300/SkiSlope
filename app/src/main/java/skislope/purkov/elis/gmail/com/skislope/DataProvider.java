...
public final class DataProvider {
    ...
    static {
        ...
        }, new LatLng(46.520992, 15.594694), "ChIJHyLPSJuCb0cRJTwSTMuVnWI");
        ...
        }, new LatLng(46.367015, 13.480740), "ChIJxcsomwa0ekcR8VlFI0dMzf8");
        ...
        }, new LatLng(46.300943, 14.531829), "ChIJDfilDBpoekcRkeUloXR_AkU");
        ...
        }, new LatLng(46.483290, 13.767500), "ChIJ1wl9b-58ekcRLNvCoX9EdWg");
        ...
        }, new LatLng(46.259695, 13.840130), "ChIJS16JnoT0ekcRCj_TIztc_ho");
        ...
        }, new LatLng(46.168506, 14.059751), "ChIJ734KHKfpekcRDsjroKcQdu4");
        ...
        }, new LatLng(46.457975, 15.333690), "ChIJ1QBl2X5-ZUcRnGPSei16PS4");
        ...
        }, new LatLng(46.372360, 14.890194), "ChIJIaMLxDJaZUcRuE1GJqE8n0k");
        ...
        }, new LatLng(46.175914, 14.185133), "ChIJbxOdgWHBekcRajXdDN4wGIU");
        ...
        }, new LatLng(46.236234, 14.007402), "ChIJU5uzK_LAekcRoN3geyM0EPM");
        ...
        }, new LatLng(46.302460, 14.630631), "ChIJxxwm2_tMZUcRfWpX3fXJSoE");

    }

    private static void addResort(String title, String homePageUrl, String wikiUrl, String email, String telNum, ParkingLot[] parkingLots, LatLng location, String placeId) {

        skiResorts.add(new SkiResort(title, homePageUrl, wikiUrl, email, telNum, parkingLots, location, placeId));
