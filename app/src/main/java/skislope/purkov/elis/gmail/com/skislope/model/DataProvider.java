...
public final class DataProvider {
    ...
    static {
        ...
        addResort("Mariborsko pohorje", "To je testiranje", "http://www.mariborskopohorje.si", "", new ParkingLot[]{
        ...
        addResort("Krvavec", "To je testiranje", "http://www.rtc-krvavec.si/si/aktivnosti/pozimi/smucisce", "https://sl.wikipedia.org/wiki/Krvavec", new ParkingLot[]{
        ...
        addResort("Kanin - Sella Nevea", "To je testiranje", "", "", new ParkingLot[]{
        ...
        addResort("Kranjska gora", "To je testiranje", "http://www.kr-gora.si/smucisce-kranjska-gora/", "https://sl.wikipedia.org/wiki/RTC_Kranjska_Gora", new ParkingLot[]{
        ...
        addResort("Vogel", "To je testiranje", "http://www.vogel.si/zima/", "https://sl.wikipedia.org/wiki/Smučišče_Vogel", new ParkingLot[]{
                new ParkingLot("Spodnja postaja žič - Ukanc 6", "", new LatLng(46.275619, 13.835516))
        }, new LatLng(46.259695, 13.840130));

        addResort("Cerkno", "To je testiranje", "http://www.hotel-cerkno.si/sl/smucanje.html", "https://sl.wikipedia.org/wiki/Smučarski_center_Cerkno", new ParkingLot[]{
        ...
        addResort("Rogla", "To je testiranje", "http://www.rogla.eu/si/nacrtujte-obisk", "https://sl.wikipedia.org/wiki/Smučišče_Rogla", new ParkingLot[]{
                new ParkingLot("Rogla", "", new LatLng(46.452322, 15.330403))
        }, new LatLng(46.457975, 15.333690));

        addResort("Golte", "To je etstiranje", "http://www.golte.si/slo/smucisce/smucarski-center", "https://sl.wikipedia.org/wiki/Golte", new ParkingLot[]{
        ...
        addResort("Stari Vrh", "To je testiranje", "http://www.starivrh.si/", "https://sl.wikipedia.org/wiki/Smučišče_Stari_vrh", new ParkingLot[]{
        ...
        addResort("Soriška planina", "To je testiranje", "http://www.soriska-planina.si/#", "https://sl.wikipedia.org/wiki/Soriška_planina", new ParkingLot[]{
                new ParkingLot("Brunarica", "", new LatLng(46.240909, 14.010432))
        }, new LatLng(46.236234, 14.007402));

        addResort("Velika planina", "To je testiranje", "http://www.velikaplanina.si/Zimske-aktivnosti/Smucanje", "https://sl.wikipedia.org/wiki/Velika_planina#smu.C4.8Di.C5.A1.C4.8De", new ParkingLot[]{
                new ParkingLot("Nihalka", "", new LatLng(46.305440, 14.609047))
        }, new LatLng(46.302460, 14.630631));

    }

    private static void addResort(String title, String description, String homePageUrl, String wikiUrl, ParkingLot[] parkingLots, LatLng location) {

        skiResorts.add(new SkiResort(title, description, homePageUrl, wikiUrl, parkingLots, location));
