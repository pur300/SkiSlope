...
public final class DataProvider {
    ...
    static {
        ...
        addResort("Krvavec", "", "http://www.rtc-krvavec.si/si/aktivnosti/pozimi/smucisce", "https://sl.wikipedia.org/wiki/Krvavec", new ParkingLot[]{
        ...
        addResort("Kanin - Sella Nevea", "", "", "", new ParkingLot[]{
        ...
        addResort("Kranjska gora", "", "http://www.kr-gora.si/smucisce-kranjska-gora/", "https://sl.wikipedia.org/wiki/RTC_Kranjska_Gora", new ParkingLot[]{
        ...
        addResort("Vogel", "", "http://www.vogel.si/zima/", "https://sl.wikipedia.org/wiki/Smučišče_Vogel", new ParkingLot[]{
                new ParkingLot("Spodnja postaja žič - Ukanc 6", "", new LatLng(46.275619, 13.835516))
        }, new LatLng(46.259695, 13.840130));

        addResort("Cerkno", "", "http://www.hotel-cerkno.si/sl/smucanje.html", "https://sl.wikipedia.org/wiki/Smučarski_center_Cerkno", new ParkingLot[]{
        ...
        addResort("Rogla", "", "http://www.rogla.eu/si/nacrtujte-obisk", "https://sl.wikipedia.org/wiki/Smučišče_Rogla", new ParkingLot[]{
                new ParkingLot("Rogla", "", new LatLng(46.452322, 15.330403))
        }, new LatLng(46.457975, 15.333690));

        addResort("Golte", "", "http://www.golte.si/slo/smucisce/smucarski-center", "https://sl.wikipedia.org/wiki/Golte", new ParkingLot[]{
        ...
        addResort("Stari Vrh", "", "http://www.starivrh.si/", "https://sl.wikipedia.org/wiki/Smučišče_Stari_vrh", new ParkingLot[]{
